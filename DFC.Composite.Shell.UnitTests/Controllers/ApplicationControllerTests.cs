...
namespace DFC.Composite.Shell.Test.Controllers
{
    public class ApplicationControllerTests
    {
        ...
        public async Task ApplicationControllerGetActionReturnsRedirectWhenRedirectExceptionOccurs()
        {
            ...
            A.CallTo(() => fakeApplicationService.GetMarkupAsync(A<ApplicationModel>.Ignored, A<PageViewModel>.Ignored, A<string>.Ignored)).Throws<RedirectRequest>();
        ...
        public async Task ApplicationControllerGetActionAddsModelStateErrorWhenPathIsNull()
        {
            ...
            A.CallTo(() => defaultLogger.Log(A<LogLevel>.Ignored, A<EventId>.Ignored, A<ApplicationController>.Ignored, A<Exception>.Ignored, A<Func<ApplicationController, Exception, string>>.Ignored)).MustHaveHappened(3, Times.Exactly);
        }
        ...
        public async Task ApplicationControllerPostActionAddsModelStateErrorWhenPathIsNull()
        {
            ...
            A.CallTo(() => fakeApplicationService.PostMarkupAsync(A<ApplicationModel>.Ignored, A<IEnumerable<KeyValuePair<string, string>>>.Ignored, A<PageViewModel>.Ignored)).Throws<RedirectRequest>();
